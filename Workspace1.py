...
X=pd.read_stata("/Users/ben/Desktop/Python/Jupyter/Econometrics_IIA/wage2.dta")
X["bin_lwage"] = pd.qcut(X.lwage,q=10, labels = False)
Variable1 = "IQ"
Variable2 = "KWW"
y="bin_lwage"
Estimators = [LDA(),QDA(),KNN(),GNB(),TREE(), Random_Forest_Classifier(Rand_Param_Search = False), SVC(probability=True)]
